...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            #     <a href='https://github.com/prabhuanantht/Next-Hire' target='_blank' style='text-decoration: none;'>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/prabhuanantht/)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [30-Days-Of-Rust](https://github.com/prabhuanantht)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/prabhuanantht'}"
                     alt="HackML"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/prabhuanantht';">
                <h2 class="profile-name">Het Patel (HackML)</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/prabhuanantht" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/patel-hetkumar-sandipbhai-8b110525a/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:prabhuanantht@gmail.com" class="social-link" target="_blank">
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/prabhuanantht)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://github.com/prabhuanantht/)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/prabhuanantht)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [GeeksforGeeks-POTD](https://github.com/prabhuanantht)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/prabhuanantht)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">TryHackMe Free Rooms</a></li>
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">Awesome Hacking</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">Awesome Java</a></li>
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">30 Days Of Rust</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">GeeksforGeeks POTD</a></li>
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">Leetcode POTD</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>AI/ML Projects:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/prabhuanantht" target="_blank" style="color: #4CAF50;">AI Nexus</a></li>
    </ul>
