...
👨‍💻 Try it Now: [![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://prabhuanantht.streamlit.app/)  
...
Open a terminal and run:
   ...
   ```bash
   git clone https://github.com/prabhuanantht/next-hire.git
   cd next-hire
   ```
...
If you encounter any issues, please [open an issue](https://github.com/yourusername/Next-Hire/issues) on GitHub.
